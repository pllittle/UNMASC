...
* Customized Local Installations
* Constructing UNMASC's `vcf`
* UNMASC execution
...
* `binom = TRUE`
* `gender = NA`
* `ncores = 1`, number of threads/cores available, helps with extracting 
strand-specific read counts per locus.
